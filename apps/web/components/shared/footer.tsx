			...
			<Container>
				<div className="flex flex-col items-center gap-8 sm:flex-row sm:justify-between">
					<div className="flex flex-col items-center gap-4 sm:items-start">
						<Link href="/">
							<Image src="/images/logo.svg" alt="Nextbook" width={120} height={24} className="h-6 w-auto" />
						</Link>
				...
				<div className="mt-8 border-border/40 border-t pt-8 text-center">
					<p className="text-muted-foreground text-xs">© {new Date().getFullYear()} Nextbook</p>
				</div>
			</Container>
		</footer>
	)
