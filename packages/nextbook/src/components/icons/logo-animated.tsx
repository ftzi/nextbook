...
const SvgLogoAnimated = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="-60 -60 3000 520"
    aria-hidden="true"
    {...props}
  >
    <defs>
      <filter
        id="logo-animated_svg__b"
        width="200%"
        height="200%"
        x="-50%"
        y="-50%"
    ...
    >
      <tspan
        fill="url(#logo-animated_svg__d)"
        stroke="url(#logo-animated_svg__d)"
        strokeWidth={11}
      >
        {"Next"}
      </tspan>
...
export default SvgLogoAnimated;
