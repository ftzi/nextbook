...
const SvgLogo = (props: SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="-60 -60 2720 520" aria-hidden="true" {...props}>
			<defs>
				...
				<linearGradient id={id1} x1={420} x2={1580} y1={0} y2={0} gradientUnits="userSpaceOnUse">
					<stop
						offset="0%"
						style={{
							stopColor: "#06b6d4",
				...
				<linearGradient id={id2} x1={0} x2={1220} y1={0} y2={0} gradientUnits="userSpaceOnUse">
					<stop
						offset="0%"
						style={{
							stopColor: "#4169e1",
			...
			>
				<tspan fill={`url(#${id1})`} stroke={`url(#${id1})`} strokeWidth={11}>
					Next
				</tspan>
			</text>
			<text
