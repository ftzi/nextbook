 ...
 * Contains metadata for Storify to detect and render stories.
 */
export type Story<TSchema extends z.ZodType | undefined = undefined> = {
	/** Marker for Storify to identify story objects */
	readonly __storify: true
 ...
 * Pass this to StorifyShell and StoryPage components.
 */
export type Stories = {
	/** Tree structure for sidebar navigation */
	tree: StoryTreeNode[]
