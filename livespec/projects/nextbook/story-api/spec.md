# Story API *[NEX-story-api]*

The `story()` function is the core API for defining component stories in nextbook. It provides a simple, type-safe way to create stories with optional Zod schemas for interactive controls.

## Design Decisions

Unlike Storybook's CSF (Component Story Format) with its metadata exports and decorators, nextbook uses a single `story()` function call — no default export required, no meta configuration, just export the result.
...
## Basic Story Definition *[NEX-story-api.basic]*

The `story()` function accepts a configuration object and returns a Story.

### Scenario: Simple story without schema *[NEX-story-api.basic.simple]*
Testing: unit
...
### Scenario: Controlled story with schema *[NEX-story-api.basic.controlled]*
Testing: unit
...
## Story Type Detection *[NEX-story-api.type-detection]*

The system detects and exposes the type of each story.

### Scenario: isStory type guard *[NEX-story-api.type-detection.is-story]*
Testing: unit
...
### Scenario: Schema presence detection *[NEX-story-api.type-detection.has-schema]*
Testing: unit
...
### Scenario: Matrix story detection *[NEX-story-api.type-detection.is-matrix]*
Testing: unit
...
## Matrix Stories *[NEX-story-api.matrix]*

The `storyMatrix()` function creates stories that render all prop combinations.

### Scenario: Matrix generation *[NEX-story-api.matrix.generation]*
Testing: unit
...
### Scenario: Matrix with non-combinatorial props *[NEX-story-api.matrix.non-combinatorial]*
Testing: unit
...
## Story Exports Discovery *[NEX-story-api.discovery]*

The system discovers all story exports from a module.

### Scenario: Named exports as stories *[NEX-story-api.discovery.named-exports]*
Testing: unit
...
### Scenario: Non-story exports ignored *[NEX-story-api.discovery.non-story-ignored]*
Testing: unit
...
### Scenario: Default export ignored *[NEX-story-api.discovery.default-ignored]*
Testing: unit
...
## Render Function Contract *[NEX-story-api.render]*

The render function receives correctly typed props.

### Scenario: Props from schema *[NEX-story-api.render.props-from-schema]*
Testing: unit
...
### Scenario: No props without schema *[NEX-story-api.render.no-props]*
Testing: unit
...
### Scenario: Schema defaults applied *[NEX-story-api.render.defaults]*
Testing: unit
