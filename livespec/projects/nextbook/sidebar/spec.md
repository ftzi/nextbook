# Sidebar Navigation *[NEX-sidebar]*

The sidebar provides navigation for the nextbook UI at `/ui`. It displays story files organized by folder structure, allowing developers to quickly browse and select components to view.
...
## Component-Centric Sidebar *[NEX-sidebar.component]*

The sidebar displays story files as single navigation items without variant expansion.

### Scenario: Story file as single item *[NEX-sidebar.component.single-item]*
Testing: e2e
...
### Scenario: No module loading in sidebar *[NEX-sidebar.component.no-loading]*
Testing: e2e
...
### Scenario: Folder organization preserved *[NEX-sidebar.component.folders]*
Testing: e2e
...
## Tabbed Story View *[NEX-sidebar.tabs]*

The story page displays all exports from a story file as tabs.

### Scenario: Tabs for all story exports *[NEX-sidebar.tabs.display]*
Testing: e2e
...
### Scenario: Tab selection via URL *[NEX-sidebar.tabs.url-select]*
Testing: e2e
...
### Scenario: Tab click updates URL *[NEX-sidebar.tabs.click-url]*
Testing: e2e
...
### Scenario: Invalid story name in URL *[NEX-sidebar.tabs.invalid-url]*
Testing: e2e
...
## Story Type Badges *[NEX-sidebar.badges]*

Tabs display badges indicating the type of each story.

### Scenario: Simple story (no badge) *[NEX-sidebar.badges.simple]*
Testing: e2e
...
### Scenario: Controlled story badge *[NEX-sidebar.badges.controlled]*
Testing: e2e
...
### Scenario: Matrix story badge *[NEX-sidebar.badges.matrix]*
Testing: e2e
...
## Single Module Load *[NEX-sidebar.single-load]*

The system loads each story module only once per navigation.

### Scenario: Module loaded on navigation *[NEX-sidebar.single-load.navigation]*
Testing: e2e
...
### Scenario: Tab switching without reload *[NEX-sidebar.single-load.tab-switch]*
Testing: e2e
...
### Scenario: Navigating to different file *[NEX-sidebar.single-load.different-file]*
Testing: e2e
...
## URL Structure *[NEX-sidebar.url]*

The URL structure remains backwards compatible.

### Scenario: File-only URL *[NEX-sidebar.url.file-only]*
Testing: e2e
...
### Scenario: File with story URL *[NEX-sidebar.url.file-story]*
Testing: e2e
...
### Scenario: Nested file URL *[NEX-sidebar.url.nested]*
Testing: e2e
...
### Scenario: Nested file with story URL *[NEX-sidebar.url.nested-story]*
Testing: e2e
...
## Tab Bar Overflow *[NEX-sidebar.overflow]*

The tab bar handles many stories gracefully.

### Scenario: Few stories (no overflow) *[NEX-sidebar.overflow.few]*
Testing: e2e

- WHEN a story file has 5 or fewer exports
- THEN all tabs are visible without scrolling

### Scenario: Many stories (overflow) *[NEX-sidebar.overflow.many]*
Testing: e2e
...
## Active Story Indicator *[NEX-sidebar.active]*

The sidebar and tab bar clearly indicate the current selection.

### Scenario: Active file in sidebar *[NEX-sidebar.active.file]*
Testing: e2e
...
### Scenario: Active tab in tab bar *[NEX-sidebar.active.tab]*
Testing: e2e
