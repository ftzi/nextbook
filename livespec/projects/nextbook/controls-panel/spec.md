# Controls Panel *[NEX-controls-panel]*
...
## Schema-Driven Controls *[NEX-controls-panel.schema]*

The controls panel generates inputs based on Zod schema types.

### Scenario: String control *[NEX-controls-panel.schema.string]*
Testing: e2e
...
### Scenario: Number control *[NEX-controls-panel.schema.number]*
Testing: e2e
...
### Scenario: Boolean control *[NEX-controls-panel.schema.boolean]*
Testing: e2e
...
### Scenario: Enum control *[NEX-controls-panel.schema.enum]*
Testing: e2e
...
### Scenario: Optional control *[NEX-controls-panel.schema.optional]*
Testing: e2e
...
## Default Value Handling *[NEX-controls-panel.defaults]*

Controls respect and display schema default values.

### Scenario: Initial values from defaults *[NEX-controls-panel.defaults.initial]*
Testing: e2e
...
### Scenario: Reset to defaults *[NEX-controls-panel.defaults.reset]*
Testing: e2e
...
## Panel Visibility *[NEX-controls-panel.visibility]*

The controls panel is toggleable.

### Scenario: Panel shown for controlled stories *[NEX-controls-panel.visibility.shown]*
Testing: e2e

- WHEN viewing a story with a schema
- THEN the controls panel is visible by default

### Scenario: Panel hidden for simple stories *[NEX-controls-panel.visibility.hidden]*
Testing: e2e

- WHEN viewing a story without a schema
- THEN no controls panel is shown

### Scenario: Panel collapse toggle *[NEX-controls-panel.visibility.collapse]*
Testing: e2e
...
## Real-Time Updates *[NEX-controls-panel.realtime]*

Control changes immediately update the story.

### Scenario: Instant re-render *[NEX-controls-panel.realtime.instant]*
Testing: e2e
...
### Scenario: URL state sync *[NEX-controls-panel.realtime.url-sync]*
Testing: e2e
