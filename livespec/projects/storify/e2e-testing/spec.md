# E2E Testing Infrastructure [STO.e2e]
...
## Test Infrastructure [STO.e2e.infrastructure]

Playwright is configured and runnable.

### Scenario: Playwright configuration [STO.e2e.infrastructure.config]
Testing: unit
...
### Scenario: Test command available [STO.e2e.infrastructure.command]
Testing: unit
...
## Sidebar Tests [STO.e2e.sidebar]

Tests verify sidebar navigation.

### Scenario: Sidebar renders story tree [STO.e2e.sidebar.renders]
Testing: e2e
...
### Scenario: Sidebar navigation works [STO.e2e.sidebar.navigation]
Testing: e2e
...
## Story Viewer Tests [STO.e2e.story-viewer]

Tests verify story rendering and viewer controls.

### Scenario: Story renders correctly [STO.e2e.story-viewer.renders]
Testing: e2e
...
### Scenario: Background toggle [STO.e2e.story-viewer.background]
Testing: e2e
...
## Controls Panel Tests [STO.e2e.controls-panel]

Tests verify the Zod-generated controls.

### Scenario: Controls render from schema [STO.e2e.controls-panel.renders]
Testing: e2e
...
### Scenario: Controls update component [STO.e2e.controls-panel.updates]
Testing: e2e
...
### Scenario: Reset restores defaults [STO.e2e.controls-panel.reset]
Testing: e2e
...
## MSW Mocking Tests [STO.e2e.mocking]

Tests verify MSW mocking for stories with API dependencies.

### Scenario: Mocks indicator visible [STO.e2e.mocking.indicator]
Testing: e2e
...
### Scenario: Mock data renders [STO.e2e.mocking.data]
Testing: e2e
...
### Scenario: Mock factory responds to controls [STO.e2e.mocking.factory]
Testing: e2e
...
### Scenario: Error states render [STO.e2e.mocking.error]
Testing: e2e

- WHEN a story mocks error response (500)
- THEN component displays error UI

### Scenario: Loading states render [STO.e2e.mocking.loading]
Testing: e2e
...
## Matrix Story Tests [STO.e2e.matrix]

Tests verify matrix view rendering.

### Scenario: Matrix grid renders [STO.e2e.matrix.renders]
Testing: e2e
...
### Scenario: Combination labels correct [STO.e2e.matrix.labels]
Testing: e2e
...
## Visual Regression [STO.e2e.visual]

Tests capture and compare screenshots.

### Scenario: Snapshots captured [STO.e2e.visual.capture]
Testing: e2e
...
### Scenario: Snapshot comparison [STO.e2e.visual.compare]
Testing: e2e
